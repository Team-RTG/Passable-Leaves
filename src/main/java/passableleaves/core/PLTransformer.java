...
public class PLTransformer implements IClassTransformer {
    ...
    public PLTransformer() {
        FMLLog.info("[PLTransformer] Initialized.");
    }
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        String methodNameOnEntityCollidedWithBlock = PLCore.isDebofEnabled ? "func_180634_a" : "onEntityCollidedWithBlock";
        ...
        String fieldNullAABB = PLCore.isDebofEnabled ? "field_185506_k" : "NULL_AABB";
        ...
        if(!transform) {
            FMLLog.info("[PLTransformer] BlockLeaves was modified by another Class transformer. Not doing changes.");
            return basicClass;
        }
        ...
        onEntityCollidedWithBlock.instructions.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "passableleaves/core/PLTransformer", "onEntityCollidedWithLeaves", "(Lnet/minecraft/entity/Entity;)V", false));
